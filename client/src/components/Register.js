...
const Register = (props) => {
    ...
    const [formData, setFormData] = useState({ name: '', email: '', otpToken: '', otp: '', pwd1: '', pwd2: '' });
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        props.setProgress(10)
        fetch(props.apiServer + '/api/auth/register', {
            method: 'POST',
            mode: 'cors',
            headers: {
                'Content-Type': 'application/json',
            ...
            .catch((err) => {
                // console.log(err.message);
                setAlert({
                    show: true, type: 'danger', message: 'Registration failed! Could not connect to server'
                })
                props.setProgress(100)
            });
    };
            ...
            <div className='container my-3'>
                ...
                <form className='col-sm-12 col-md-6' method='POST' onSubmit={handleSubmit}>
                    <div className='mb-3'>
                        ...
                        <input value={formData.name} onChange={handleChange} type='text' className='form-control' id='name' name='name' required />
                    </div>
                    <div className='mb-3'>
